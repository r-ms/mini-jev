...
| Is it faster? | On short texts, yes: 0.24× the time of JSON at 32-token texts (1 field), 0.6–0.8× at 512 tokens. Without a shared prefix it loses at 2048 tokens with 2–3 fields (1.10–1.16×); with the shared prefix (KV cache of the text reused across questions) it wins at every field count (0.41–0.71×). | runs b2/b3, [figure](docs/figures/cost_by_length.svg) |
